...
const PayTicket = ({rootData, reservationData}) => {
  // 예매 관련 상태 및 함수
  ...
  const handleGoBack = () => {
    ...
    <div className="infoBox">
      ...
      <BuyerInfoWrapper isExpanded={isExpandedInputInfo} onClick={handleHeaderClickInput}>
      ...
      <PriceQuantityWrapper isExpanded={isExpandedPrice} onClick={handleHeaderClickPrice}>
      <div className="wrapperHeader">
        <h4>가격 정보</h4>
